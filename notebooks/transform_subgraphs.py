...
def main(args):
    ...
    for input_f in tqdm(input_files):
        pid = '.'.join(input_f.split('.')[:-1])
        
        # Create output directory
        if not os.path.exists(os.path.join(output_dir, pid)):
            os.mkdir(os.path.join(output_dir, pid))
        ...
        with open(os.path.join(output_dir, pid, 'entity2id.txt'), 'w') as relation_f:
        ...
        with open(os.path.join(output_dir, pid, 'relation2id.txt'), 'w') as relation_f:
        ...
        # train2id.txt
        with open(os.path.join(output_dir, pid, 'train2id.txt'), 'w') as train_f:
        ...
        # test2id.txt
        with open(os.path.join(output_dir, pid, 'test2id.txt'), 'w') as test_f:
        ...
        # valid2id.txt
        with open(os.path.join(output_dir, pid, 'valid2id.txt'), 'w') as validation_f:
        ...
        subprocess.Popen(['python3', '-m', 'n-n', '--input-dir', os.path.join(output_dir, pid)])
